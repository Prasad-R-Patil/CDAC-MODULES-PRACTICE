...
public class XYZ {
	public static void main(String[] args) {
		...
		System.out.println("Collage Student Are Passed in A Gread No Of Student is => "+cnt);
		...
		System.out.println("School Student Are Passed in A Gread No Of Student is => "+cnt);
		System.out.println("---------------------------------------------------------------------");
